        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultVendor = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Parts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Parts_Households_HouseholdId",
                        column: x => x.HouseholdId,
                        principalSchema: "steward",
                        principalTable: "Households",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplicableCategories = table.Column<string[]>(type: "text[]", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Templates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Templates_Households_HouseholdId",
                        column: x => x.HouseholdId,
                        principalSchema: "steward",
                        principalTable: "Households",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EngineScoped = table.Column<bool>(type: "boolean", nullable: false),
                    RecurrenceIntervalMonths = table.Column<int>(type: "integer", nullable: true),
                    RecurrenceIntervalMiles = table.Column<decimal>(type: "numeric", nullable: true),
                    RecurrenceIntervalHours = table.Column<decimal>(type: "numeric", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "TemplateStepSuggestedPart",
                schema: "steward",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TemplateStepSuggestedPart", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TemplateStepSuggestedPart_TemplateSteps_TemplateStepId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MaintenanceItems_Assets_AssetId",
                        column: x => x.AssetId,
                        principalSchema: "steward",
                        principalTable: "Assets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MaintenanceItems_Engines_EngineId",
                        column: x => x.EngineId,
                        principalSchema: "steward",
                        principalTable: "Engines",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    MaintenanceItemId = table.Column<Guid>(type: "uuid", nullable: false),
                    Text = table.Column<string>(type: "text", nullable: false),
                    Status = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChecklistItems_Engines_EngineId",
                        column: x => x.EngineId,
                        principalSchema: "steward",
                        principalTable: "Engines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ChecklistItems_MaintenanceItems_MaintenanceItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PartLines_ChecklistItems_ChecklistItemId",
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_PartLines_MaintenanceItems_MaintenanceItemId",
                        column: x => x.MaintenanceItemId,
                        principalSchema: "steward",
                        principalTable: "MaintenanceItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PartLines_Parts_PartId",
                        column: x => x.PartId,
                        principalSchema: "steward",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChecklistItems_EngineId",
                schema: "steward",
                table: "ChecklistItems",
                column: "EngineId");

            migrationBuilder.CreateIndex(
                name: "IX_ChecklistItems_MaintenanceItemId",
                schema: "steward",
                table: "ChecklistItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceItems_AssetId",
                schema: "steward",
                table: "MaintenanceItems",
                column: "AssetId");

            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceItems_EngineId",
                schema: "steward",
                table: "MaintenanceItems",
                column: "EngineId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PartLines_ChecklistItemId",
                schema: "steward",
                table: "PartLines",
                column: "ChecklistItemId");

            migrationBuilder.CreateIndex(
                name: "IX_PartLines_MaintenanceItemId",
                schema: "steward",
                table: "PartLines",
                column: "MaintenanceItemId");

            migrationBuilder.CreateIndex(
                name: "IX_PartLines_PartId",
                schema: "steward",
                table: "PartLines",
                column: "PartId");

            migrationBuilder.CreateIndex(
                name: "IX_Parts_HouseholdId",
                schema: "steward",
                table: "Parts",
                column: "HouseholdId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TemplateStepSuggestedPart_TemplateStepId",
                schema: "steward",
                table: "TemplateStepSuggestedPart",
