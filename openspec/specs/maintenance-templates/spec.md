# maintenance-templates Specification

## Purpose
Defines the maintenance template API: household-owned and platform-owned templates, their steps and suggested parts, platform template administration, duplication, seeding, and how a template expands into a maintenance item's checklist and part lines.
