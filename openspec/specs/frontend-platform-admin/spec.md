# frontend-platform-admin Specification

## Purpose
Defines the frontend admin shell, route guarding, and navigation for PlatformAdmin-only screens, starting with platform template management.
