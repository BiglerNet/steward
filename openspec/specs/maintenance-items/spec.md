# maintenance-items Specification

## Purpose
Defines the maintenance item CRUD API, including its checklist items and part lines, replacing the former service-record tracking API with a planning-capable lifecycle.
