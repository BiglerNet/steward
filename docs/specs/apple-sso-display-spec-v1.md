[Overview](https://developer.apple.com/documentation/signinwithapple/displaying-sign-in-with-apple-buttons-on-the-web?utm_source=chatgpt.com#overview)
------------------------------------------------------------------------------------------------------------------------------------------------------
...
### [Create a wrapper tag and configure localization](https://developer.apple.com/documentation/signinwithapple/displaying-sign-in-with-apple-buttons-on-the-web?utm_source=chatgpt.com#Create-a-wrapper-tag-and-configure-localization)
...
Replace `en_US` in the code above with your localization code. For a list of available locales, see [Incorporating Sign in with Apple into other platforms](https://developer.apple.com/documentation/signinwithapple/incorporating-sign-in-with-apple-into-other-platforms).

### [Specify property values](https://developer.apple.com/documentation/signinwithapple/displaying-sign-in-with-apple-buttons-on-the-web?utm_source=chatgpt.com#Specify-property-values)
...
#### [Set the mode](https://developer.apple.com/documentation/signinwithapple/displaying-sign-in-with-apple-buttons-on-the-web?utm_source=chatgpt.com#Set-the-mode)
...
#### [Set the type](https://developer.apple.com/documentation/signinwithapple/displaying-sign-in-with-apple-buttons-on-the-web?utm_source=chatgpt.com#Set-the-type)
...
#### [Set the color](https://developer.apple.com/documentation/signinwithapple/displaying-sign-in-with-apple-buttons-on-the-web?utm_source=chatgpt.com#Set-the-color)
...
#### [Set the border and radius](https://developer.apple.com/documentation/signinwithapple/displaying-sign-in-with-apple-buttons-on-the-web?utm_source=chatgpt.com#Set-the-border-and-radius)
...
#### [Set the width and height](https://developer.apple.com/documentation/signinwithapple/displaying-sign-in-with-apple-buttons-on-the-web?utm_source=chatgpt.com#Set-the-width-and-height)
...
#### [Set the logo size and position](https://developer.apple.com/documentation/signinwithapple/displaying-sign-in-with-apple-buttons-on-the-web?utm_source=chatgpt.com#Set-the-logo-size-and-position)
...
#### [Set the label position](https://developer.apple.com/documentation/signinwithapple/displaying-sign-in-with-apple-buttons-on-the-web?utm_source=chatgpt.com#Set-the-label-position)
